...
local on_attach = function(client, bufnr)
  ...
  vim.keymap
      .set('n', '<leader>wa', vim.lsp.buf.add_workspace_folder, buf_opts)
  ...
  vim.keymap.set('n', '<leader>f', function() async_formatting(bufnr) end,
    buf_opts)
...
require('mason-lspconfig').setup {
  ensure_installed = { 'lua_ls', 'tsserver', 'tailwindcss', 'jsonls', 'jdtls' },
